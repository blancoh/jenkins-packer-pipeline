...
/usr/local/bin/aws ecr delete-repository --repository-name ${repo_folder}/${repo_name} --force
#Create ECR Repository
/usr/local/bin/aws ecr create-repository --repository-name ${repo_folder}/${repo_name}
